...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, out_channel=64):
        ...
        self.downsample = 2
        # self.fpn = ops.FeaturePyramidNetwork([64, 256, 512, 1024, 2048], self.out_channel)
        self.fpn = ops.FeaturePyramidNetwork([64, 64, 128, 256, 512], self.out_channel, norm_layer=norm_layer)
    ...
    def _forward_impl(self, x):
        ...
        x = self.bn1(x)
        x0 = self.relu(x)
        x0_mp = self.maxpool(x0)

        x1 = self.layer1(x0_mp)
        x2 = self.layer2(x1)
        x3 = self.layer3(x2)
        x4 = self.layer4(x3)

        fpn_dict = OrderedDict()
        fpn_dict['feat0'] = x0
        fpn_dict['feat1'] = x1
        fpn_dict['feat2'] = x2
        fpn_dict['feat3'] = x3
        ...
        return self.fpn(fpn_dict)['feat0']
